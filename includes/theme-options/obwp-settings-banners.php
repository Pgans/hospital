	...
	if($count>0)
	{
		for($i=1; $i<=$count; $i++)
		{
			...
			$options[] = array(	"name" => "URL",
							"desc" => "Enter url of 125x125 Ad. Do not forget to add http://<br /><br />",
							"id" => SHORTNAME."_banner_125_125_url_".$i,
							"std" => "",
							"type" => "text");
			
			$options[] = array(	"name" => "Image",
							"desc" => "Enter image of 125x125 Ad. Do not forget to add http://<br /><br />",
							"id" => SHORTNAME."_banner_125_125_img_".$i,
							"std" => "",
							"type" => "text");
			
			$options[] = array(	"name" => "Title",
							"desc" => "Enter title of 125x125 Ad.<br /><br />",
