                ...
                <div class="col-md-3">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div>
                                <ul class="xoxo blogroll">
                                    <li><a href="http://192.168.200.4/service/meeting/index.php" target="_blank">ระบบจองห้องประชุม</a></li>
                                    <li><a href="http://192.168.200.2/dhdc2" target="_blank">DHDC(43แฟ้ม)</a></li>
                                    <li><a href="http://192.168.200.4/service/index.php?show=add_job" target="_blank">ระบบส่งซ่อมคอมพิวเตอร์</a></li>
                                    <li><a href="http://192.168.200.4/service/index.php?show=add_job" target="_blank">ระบบสื่อโสตทัศนศึกษา</a></li>
                                    <li><a href="http://192.168.200.2/yii2a-devices/backend/web/index.php" target="_blank">ระบบบุคลากร</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
