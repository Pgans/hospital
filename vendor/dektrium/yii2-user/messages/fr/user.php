...
return [
    ...
    'In order to complete your request, we need you to verify that you initiated this request' => '@@Afin de compléter votre demande, vous devez vérifier que cette demande émane de vous@@',
    ...
    'Password recovery finished' => '@@Récupération du mot de passe terminé@@',
    ...
    'Role' => '@@Role@@',
    'Thank you for registration on our website. You may sign in using your credentials.' => '@@Merci de vous être inscrit sur notre site. Vous pouvez vous connecter en utilisant vos identifiants.@@',
    ...
    'Update user profile' => '@@Mise à jour du profil de l\'utilisateur@@',
    ...
    'We need to confirm your email address' => '@@Nous avons besoin de la confirmation de votre e-mail.@@',
    'You have been sent an email with instructions on how to reset your password.' => '@@Un e-mail contenant des instructions sur comment réinitialiser votre mot de passe vous a été envoyé.@@',
    'You have successfully cancelled email changing process' => '@@vous avez annulé le processus de changement d\'e-mail avec succès@@',
    ...
    'You can now log in with the following credentials:' => 'Vous pouvez maintenant vous connecter avec les identifiants suivants :',
